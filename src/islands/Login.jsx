            ...
            <div className="fixed inset-0 flex items-center justify-center p-5 pointer-events-none opacity-90">
                <div className="pointer-events-auto w-full max-w-[400px] bg-white backdrop-blur-xl rounded-3xl shadow-2xl shadow-black/40 border border-white/20 p-8">
                    ...
                    <div className="flex items-center mb-2">
                        <span className="material-symbols-outlined gap-2 pr-2 bg-gradient-to-r rom-blue-500 via-slate-500 to-slate-800 bg-clip-text text-transparent">waves</span>
                    ...
                    <div className="flex gap-1 bg-slate-100 p-1 rounded-full mb-6">
                        <div className="flex-1 h-9 rounded-full text-sm font-semibold bg-slate-900 text-white flex items-center justify-center">
                            Iniciar sesión
                        </div>
                        <div className="flex-1 h-9 rounded-full text-sm font-semibold text-slate-500 flex items-center justify-center">
                            Crear cuenta
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <button type="button" className="w-full h-11 rounded-xl bg-slate-900 text-white font-semibold text-sm transition-transform hover:-translate-y-0.5 active:scale-[.98]">
                            Entrar
                        </button>
